<?php include('partials/menu.php'); ?>
     ...
     <div class="menu-content">
         <div class="wrapper">
           ...
           <h1 class="addcolor">Manage Admin</h1> <br><br>
              <?php 
        ...
        <a href="add-admin.php" class="btn-primary">Add Admin</a> <br><br><br>
           ...
           <table class="tbl-full">
            ...
            //query to get admin
             ...
             if($res==TRUE)
             {
                //count the rowws to check whether we have data in database or not
                $count=mysqli_num_rows($res); //Function to get all the rows in database
                $sn=1; // create a variable and asssign the value
                ...
                if($count>0)
                {
                    ...
                    {
                      //using while loop get all the from the db
                ...
                {
                  //we Do not have data from database
                }
             }
