  ...
  <div class="wrapper">
    <h1>Manage Food</h1> <br><br>
     ...
     <table class="tbl-full">
      ...
      //ctreate a sql query to get all the food
      ...
      //create  searial number variable and set defualt value as 1
      $sn=1;
      ...
      if($count>0)
      {
        ...
        {
          //get the value form indivisual columns
          $id=$row['id'];
          $title=$row['title'];
          $price=$row['price'];
